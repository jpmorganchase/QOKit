...
# dummy parameters
gamma = [0.        , 0.78539816, 1.57079633, 2.35619449, 3.14159265]
beta = [3.14159265, 2.35619449, 1.57079633, 0.78539816, 0.        ]
...
def test_listing_1():
    ...
    terms = [(.3, (i, j)) for i in range(n) for j in range(i+1, n)]
